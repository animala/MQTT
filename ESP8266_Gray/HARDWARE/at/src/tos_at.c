...
static at_event_t *at_event_do_get(char *buffer, size_t buffer_len)
{
    int i = 0;
...
static at_event_t *at_get_event(void)
{
    char *buffer;
    size_t buffer_len;
...
static int at_is_echo_expect(void)
{
...
static at_parse_status_t at_uart_line_parse(void)
{
    size_t curr_len = 0;
...
static void at_echo_status_set(at_echo_t *echo)
{
    char *buffer;
    at_cache_t *at_cache;
...
static void at_echo_buffer_copy(at_cache_t *at_cache, at_echo_t *echo)
{
...
static void at_parser(void *arg)
{
    at_echo_t *at_echo = K_NULL;
...
static int at_uart_send(const uint8_t *buf, size_t size, uint32_t timeout)
{
    int ret;
...
static int at_cmd_do_exec(const char *format, va_list args)
{
    size_t cmd_len = 0;
...
static int at_recv_cache_init(void)
{
...
static void at_recv_cache_deinit(void)
{
    uint8_t *buffer = K_NULL;
...
static at_data_channel_t *at_channel_get(int channel_id, int is_alloc)
{
    /*
